 ...
 * ラッパーイテレータを生成します。イテレータはイテレーションごとに、変換された値を返却します
 ...
 * ラッパーイテレータを生成します。イテレータはイテレーションごとに、受入条件を満たした値のみを返却します
 * @param iterator source iterator. this iterator will be consumed
 ...
 * ラッパーイテレータを生成します。イテレータはイテレーションごとに、拒否条件を満たさなかった値のみを返却します
 * @param iterator source iterator. this iterator will be consumed
 ...
 * ラッパーイテレータを生成します。イテレータはイテレーションごとに、各イテラブルの値を1つずつ集めた配列を返却します  
